...
const closestChargeFraction = computed(() => Object.entries(cellCapacity).reduce((prev, curr) => {
    return (Math.abs((curr[1] * cellCount.value) - props.cellCurrentVoltage) < Math.abs((prev[1] * cellCount.value) - props.cellCurrentVoltage) ? curr : prev);
})[0] * 100);
    ...
    <div class="uk-card uk-card-default uk-card-body">
        ...
        <div class="cell-calculator-container">
            <div class="calculator-cell-count statistic">
                ...
                <input v-model="cellCount" class="uk-input" type="text" placeholder="0">
            </div>
            ...
            <div class="live-stats-display">
                <div class="battery-outline">
                    ...
                    <div class="battery-stat-group">
                        <span class="battery-stat">{{ props.cellCurrentVoltage.toFixed(1) + "V" }}</span>
