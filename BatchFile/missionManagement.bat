...
rem Example for above: start cmd.exe /c "cd C:\Users\winky\Documents\MUAS\Mission-Management && npm run serve"
start cmd.exe /c "python <Paste complete path to the DronelinkServer.py file>"
rem Example for above: start cmd.exe /c "python C:\Users\winky\Documents\MUAS\Mission-Management\Backend\DronelinkServer.py"
